...
\begin{bnuindex}
    ...
    \indexletter{T}
    \indexentry{图 Transformer 稀疏化方法}{idx:theme:sparsegraphtransformer}
    ...
    \indexletter{D}
    \indexentry{DIFFormer}{idx:name:difformer}
    ...
    \indexletter{N}
    \indexentry{NAGphormer}{idx:name:nagphormer}
    \indexentry{NodeFormer}{idx:name:nodeformer}

    \indexletter{S}
    \indexentry{SDGNN（稀疏分解图神经网络）}{idx:name:sdgnn}
    \indexentry{SGC（简单图卷积）}{idx:name:sgc}
    \indexentry{SGFormer}{idx:name:sgformer}
