...
\bnusetup{
  ...
  %   可使用“\\”命令手动控制换行
  %
  title  = {MSAS-GNN：谱驱动自适应稀疏图神经网络的鲁棒高效推理},
  title* = {MSAS-GNN: Spectral-Driven Multi-Scale Adaptive Sparse Graph Neural Networks for Robust and Efficient Inference},
  %
  % 学科门类
  %   1. 学术型
  %      - 中文
  ...
  %   3. 本科生不需要填写
  %
  degree-category  = {经济学专业硕士},
  degree-category* = {Master of Economic},
  %
  % 培养单位
  %   填写所属院系的全名
  %
  ...
  author  = {常昊},
  author* = {Chang Hao},
  student-id = {202422011122},
  %
  % 导师姓名、职称
  %   中文姓名和职称之间以英文逗号“,”分开，下同
  %
  supervisor  = {翟铮, 副教授},
  supervisor* = {Associate Professor Zhai Zheng},
  supervisor-department = {统计学院},
  %
  % 副导师姓名、职称
  %
...
\bnusetup{
  ...
  math-font  = newcm,  % stix | xits | libertinus | newcm 
