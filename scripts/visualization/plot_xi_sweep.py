...
def main():
    parser=argparse.ArgumentParser(); parser.add_argument("--results_file",default="outputs/results/appendix_xi_sweep.json"); parser.add_argument("--output_dir",default="outputs/figures/appendix"); args=parser.parse_args()
    ...
    ax.set_xlabel("ξ"); ax.set_ylabel("Test Accuracy (%)"); ax.legend(); ax.set_title("附录C.3：ξ细粒度扫描")
